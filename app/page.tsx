...
const COMPANY_EMAIL = 'novacreations111@gmail.com'
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <a
              ...
              className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-full hover:opacity-80 transition-all duration-200 shadow-sm hover:shadow-md transform hover:scale-110"
              title="Message us on WhatsApp"
            >
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/whatsapp.jfif-410ZamlH1ErwhSzcqfn6CWpkzvYRux.jpeg"
                alt="WhatsApp"
                width={40}
                height={40}
            ...
            >
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/tk-hFuwZzxa9RjOTY3Zv3sVxooBV9fpkq.png"
                alt="TikTok"
                width={40}
                height={40}
                className="rounded-full w-10 h-10 md:w-12 md:h-12"
